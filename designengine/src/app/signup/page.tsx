...
function SignupForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (authError) {
      track('signup_failed', { error: authError.message });
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account and start designing.
          </p>
        </div>
      </div>
    );
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Start building design systems that make AI output look human.
        </p>
        ...
        <p style={{
          ...
          <Link href="/login" style={{ color: 'var(--color-green-deep)', fontWeight: 500 }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
